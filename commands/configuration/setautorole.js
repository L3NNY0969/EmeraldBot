module.exports = class SetAutoRole {
    ...
    async run(bot, msg, args) {
        ...
        if (msg.mentions.roles.first() || args[0] === "reset" || msg.guild.roles.get(args[0])) {
            ...
            msg.channel.send(bot.embed({
                ...
                description: `The auto role ${msg.mentions.roles.first() ? `was updated to ${msg.mentions.roles.first()}\nUsers who join will receive this role` : msg.guild.roles.get(args[0]) ? `was updated to ${msg.guild.roles.get(args[0])}\nUsers who join will receive this role` : "has been reset"}.`
            }));
        } else {
